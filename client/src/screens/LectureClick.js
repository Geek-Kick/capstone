            ...
            <Container style={{ margin: 20 }}>
                <VideoContainer>
                    <Image
                        ...
                        style={{ borderRadius: 0, width: Dimensions.get('window').width, height: 300, margin: 10 }}
                        showButton={true}
                ...
                <IntroduceContainer>
                    ...
                    <StyledText style={{ marginTop: 5, marginBottom: 5 }}>추천 대상</StyledText>
                ...
                <IntroduceContainer>
                    ...
                    <ReviewContainer>
                        ...
                        <ReviewDesc>저 같은 돌머리도 이해시켜주시는 문법강의 구세주입니다!!</ReviewDesc>
                        <ReviewTextContainer containerStyle={{ marginTop: 10 }}>
                            <MaterialIcons name="star" size={24} color="#F8C646" />
                            <MaterialIcons name="star" size={24} color="#F8C646" />
                            <MaterialIcons name="star" size={24} color="#F8C646" />
                    ...
                    <ReviewContainer>
                        ...
                        <ReviewDesc>이 강의 듣고 9월 모평 1등급 맞았습니다. 갓혜정</ReviewDesc>
                        <ReviewTextContainer containerStyle={{ marginTop: 10 }}>
                            <MaterialIcons name="star" size={24} color="#F8C646" />
                            <MaterialIcons name="star" size={24} color="#F8C646" />
                            <MaterialIcons name="star" size={24} color="#F8C646" />
