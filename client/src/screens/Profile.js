            ...
            <Container style={{ margin: 20 }}>
                <RowContainer>
                    <ColumnContainer>
                        ...
                        <Button title="내 정보수정 >" onPress={() => { }}
                            containerStyle={{ backgroundColor: '#a6a6a6', width: 20, height: 30, marginRight: 220 }}
                            textStyle={{ fontSize: 10 }} />
                    </ColumnContainer>

                    <Image source="https://firebasestorage.googleapis.com/v0/b/rn-chat-fb183.appspot.com/o/icon.png?alt=media" style={{ width: 130, height: 130, marginTop: 20 }} />

                </RowContainer>
                <Button title="Main" containerStyle={{
                    flex: 1, width: 20, borderRadius: 0
                ...
                <RowContainer>
                    ...
                    <Input label="최근 게시글" value="----------------------------------------" containerStyle={{ height: 10, }} style={{ width: 500, height: 55 }} />
                </RowContainer>
